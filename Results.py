...
class Results:
    def __init__(self, num_samples, num_cols, dist):
        ...
        self.u_uni_pcoa_diff = None
        self.u_uni_nj_diff = None

        self.w_uni_cluster_diff = None
        self.w_uni_pcoa_diff = None
        self.w_uni_nj_diff = None
    ...
    def print_results(self, out_file):
        out_file.write("%d,%d,%s,"
                       ...
                       (self.num_samples,
                        ...
                        self.u_uni_nj_diff[0],
                        self.u_uni_nj_diff[1],
                        self.u_uni_nj_diff[2],
                        self.w_uni_nj_diff[0],
                        self.w_uni_nj_diff[1],
                        self.w_uni_nj_diff[2],
                        ...
                        self.bc_nj_diff[1],
                        self.bc_nj_diff[2],
                        self.u_uni_pcoa_diff[0],
                        self.u_uni_pcoa_diff[1],
                        self.u_uni_pcoa_diff[2],
                        self.w_uni_pcoa_diff[0],
                        self.w_uni_pcoa_diff[1],
                        self.w_uni_pcoa_diff[2],
                        self.bc_pcoa_diff[0],
                        self.bc_pcoa_diff[1],
                        self.bc_pcoa_diff[2],
